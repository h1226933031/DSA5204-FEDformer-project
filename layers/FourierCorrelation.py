...
class FourierBlock(nn.Module):
    def __init__(self, in_channels, out_channels, seq_len, modes=0, mode_select_method='random', logger=None):
        ...
        logger.info('Self Attention modes={}, index={}'.format(modes, self.index))
